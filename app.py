...
DEMO_DATA = {
    ...
    'students': [
        (1, 'Priya Singh', 'Invertis University', 3, 'Love Python and Web Development. Looking for partners for assignments.'),
        (2, 'Amit Verma', 'Invertis University', 3, 'Strong in DBMS and algorithms. Can help with database queries.'),
        (3, 'Neha Gupta', 'Invertis University', 3, 'Good at Operating Systems and Discrete Maths. Morning study sessions.'),
        (4, 'Rohit Kumar', 'Invertis University', 3, 'Interested in AI and Machine Learning. Notes sharing enthusiast.'),
        (5, 'Sneha Yadav', 'Invertis University', 3, 'Loves C++ and Data Structures. Night owl study sessions preferred.'),
        (6, 'Vivek Sharma', 'Invertis University', 3, 'Frontend developer in making. Good at HTML, CSS, JavaScript basics.'),
    ],
    'members': [
        (999, 'Demo User', 3, 'Invertis University'),
        (1, 'Priya Singh', 3, 'Invertis University'),
        (2, 'Amit Verma', 3, 'Invertis University'),
