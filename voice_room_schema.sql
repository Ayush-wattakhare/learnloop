-- Voice Room Feature Database Schema
...
CREATE INDEX idx_voice_rooms_active ON `voice_rooms`(is_active);
CREATE INDEX idx_voice_rooms_host ON `voice_rooms`(host_id);
CREATE INDEX idx_room_participants_room ON `room_participants`(room_id);
CREATE INDEX idx_room_participants_user ON `room_participants`(user_id);
CREATE INDEX idx_room_messages_room ON `room_messages`(room_id);
CREATE INDEX idx_stage_requests_room ON `stage_requests`(room_id);
